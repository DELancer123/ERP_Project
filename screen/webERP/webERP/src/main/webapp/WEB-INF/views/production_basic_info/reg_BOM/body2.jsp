...
<body>
<form name="form1" id="regBOM" method="get">
   ...
   <tr align="center">
    ...
    <td><input type="checkbox" name="content"/></td>
    	...
    	<td><input type="text" name="precisionQuantity" value='${precisionQuantity}'/></td>
    	 ...
    	 /*var item = document.getElementsByName("content").length;
    	  ...
    	  for(var i=0; i<item;i++){
    		  if(document.getElementsByName("content")[i].checked==true){
    			  ...
    			  window.location.href = "${contextPath}/member/updateBOM.do?itemCode="+itemCode;
    		  }
    	  }*/
      ...
      //update_button.onclick(function(){
   		...
   		//var unit = $("unit").val();
   		//document.form1.action="{contextPath}/member/updateBOM.do"
