...
public interface ItemViewController {
	...
	public ModelAndView addMember(@ModelAttribute("item") ItemVO itemVO,HttpServletRequest request, HttpServletResponse response) throws Exception;
...
*/
	ModelAndView updateMember(@ModelAttribute("item") ItemVO itemVO, HttpServletRequest request, HttpServletResponse response) throws Exception;
