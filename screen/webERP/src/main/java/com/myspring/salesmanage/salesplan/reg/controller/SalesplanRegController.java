...
public interface SalesplanRegController {
	...
	//reg
//	public ModelAndView updNewSalesplan(@ModelAttribute("info")SalesplanVO salesplan,HttpServletRequest request, HttpServletResponse response) throws Exception;
