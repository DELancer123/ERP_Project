...
public interface SalesplanRegController {
	...
	//reg
//	public ModelAndView updNewSalesplan(@ModelAttribute("saleplan")ItemViewVO saleplanVO,HttpServletRequest request, HttpServletResponse response) throws Exception;
	public ModelAndView removeSalesplan(HttpServletRequest request, HttpServletResponse response) throws Exception;
	public ModelAndView addSalesplan(@ModelAttribute("salesplan")ItemViewVO itemviewVO,HttpServletRequest request, HttpServletResponse response) throws Exception;
