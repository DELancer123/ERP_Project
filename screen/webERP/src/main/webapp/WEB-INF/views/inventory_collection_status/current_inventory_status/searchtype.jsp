...
<body>
				...
				success : function(responseData){
					...
					$("#searchItem").empty();
						...
						var str = '';
							...
							str +=  '<td><input type = "text" id="iCode" name ="iCode" value = "'+data[i].itemCode+'"></td>';  
							str +=  '<td><input type = "text" id="iName" value = "'+data[i].itemName+'" ></td>';  
							str +=	'</tr>';
	...
	//text_code.value = iCode;
	//text_name.value = iName;
